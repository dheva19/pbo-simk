...
echo [4/4] Menginstal dependensi Tailwind CSS (Node.js dibutuhkan)...
python manage.py tailwind install
if errorlevel 1 (
    echo [ERROR] Gagal menginstal Tailwind! Pastikan Node.js sudah terinstal dan theme app sudah di-init.
    pause
    exit /b
)
